package Box2D.Dynamics.Contacts
{
	...
	*/
	public class b2ContactSolver
	{
		...
		private static const s_worldManifold:b2WorldManifold = new b2WorldManifold();
		public function Initialize(step:b2TimeStep, contacts:Vector.<b2Contact>, contactCount:int, allocator:*):void
		{
			...
			for (i = 0; i < contactCount; ++i)
			{
				...
				var friction:Number = b2Settings.b2MixFriction(fixtureA.friction, fixtureB.friction);
				var restitution:Number = b2Settings.b2MixRestitution(fixtureA.restitution, fixtureB.restitution);
	...
	//#else
		// Sequential solver.
		private static const s_psm:b2PositionSolverManifold = new b2PositionSolverManifold();
		public function SolvePositionConstraints(baumgarte:Number):Boolean
		{
			var minSeparation:Number = 0.0;
	...
	//#endif
		private const m_step:b2TimeStep = new b2TimeStep();
