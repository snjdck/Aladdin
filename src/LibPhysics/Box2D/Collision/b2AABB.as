package Box2D.Collision
{
	...
	*/
	public class b2AABB
	{
		...
		/** The lower vertex */
		public const lowerBound:b2Vec2 = new b2Vec2();
		/** The upper vertex */
		public const upperBound:b2Vec2 = new b2Vec2();
		...
		*/
		...
		{
			return new b2Vec2(
				(lowerBound.x + upperBound.x) * 0.5,
				(lowerBound.y + upperBound.y) * 0.5
			);
		}
		...
		{
			return new b2Vec2(
				(upperBound.x - lowerBound.x) * 0.5,
				(upperBound.y - lowerBound.y) * 0.5
			);
		}
